 ...
 * V3.01 20181225_juergs: some changes, due testing failures. Switched WIFI off, added. snesortec credentials moved to EOT.      
 *       
 ***********************************************************************************************************************
...
/* RFM69 */
  ...
  #ifdef ESP8266
    #define RFM_SS             D8          //15   SS pin -> RFM69 (NSS)  //for both Soft- and HW-SPI  (D8)
...
void setup()
{
  ...
  //      http://bbs.espressif.com/viewtopic.php?t=836
    ...
    // Pemue@fhem pcb design nanoLGW with standard i2c constructor.   
    Wire.begin();
    ...
    //sleep(1000); //short time to read settings
